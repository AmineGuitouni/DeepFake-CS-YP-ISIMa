...
class FakeDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # Read input image
        # ----------
        input_file_name = self.input_image_paths[item].replace("[ROOT]/",'').replace("//","/")
        try:
        ...
        # Read mask
        # ----------
        mask_file_name = self.mask_image_paths[item].replace("[ROOT]/",'').replace("//","/")
        ...
        # Read edge
        # ----------
        edge_file_name = self.edge_image_paths[item].replace("[ROOT]/",'').replace("//","/")
